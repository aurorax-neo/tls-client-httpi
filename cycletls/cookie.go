...
// convertFHTTPCookiesToNetHTTPCookies converts a slice of fhttp cookies to net/fhttp cookies.
func convertFHTTPCookiesToNetHTTPCookies(fhttpCookies []*fhttp.Cookie) []*nhttp.Cookie {
